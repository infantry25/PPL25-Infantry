                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Icon Aplikasi</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form method="POST" action="{{ route('proses-icon') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <div class="custom-file">
                                                        <input type="file" id="inputimage" name="icon"
                                                ...
                                                <img src="{{ $konfig->icon_url }}" id="image-preview"
                                        ...
                                        <div class="col-sm-6">
                                            <p>Icon Sekarang</p>
                                            <img src="{{ $konfig->icon_url }}" class="img-fluid img-thumbnail"
                                                style="width: 400px">
                                        </div>
                                    </div>
