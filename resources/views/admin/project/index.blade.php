                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @endcan
                                        <td>{{ $project->categories->nama_kategori }}</td>
                                        <td>{{ $project->nama }}</td>
                                        <td>{{ $project->lokasi }}</td>
                                        <td>{!! $project->deskripsi !!}</td>
                                        <td class="text-center">
                                            <a href="{{ route('project.show', $project->id) }}"
                                                type="button" class="btn btn-outline-info mx-2">
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a href="{{ route('project.edit', $project->id) }}"
                                                    type="button" class="btn btn-outline-warning mx-2">
                                                ...
                                                <form action="{{ route('project.destroy', $project->id) }}"
                                                    ...
                                                    <button class="btn btn-outline-danger delete" type="submit"
                                                        data-id="{{ $project->id }}" data-toggle="tooltip"
                                                        title='Delete'><i class="fas fa-trash"></i></button>
                                                    <!-- <button class="btn btn-outline-danger delete" type="button"
                                                        data-id="{{ $project->id }}" data-toggle="tooltip" title='Delete'><i
