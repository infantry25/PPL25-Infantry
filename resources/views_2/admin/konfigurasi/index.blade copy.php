                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('tentang') is-invalid @enderror" name="tentang" rows="5">{{ old('tentang', $konfig->tentang) }}</textarea>
                                            </div>
                                            @error('tentang')
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" rows="4">{{ old('deskripsi', $konfig->deskripsi) }}</textarea>
                                            </div>
                                            @error('deskripsi')
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="nama_singkat" value="{{ old('nama_singkat', $konfig->nama_singkat) }}">
                                            </div>
                                            @error('nama_singkat')
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email"
                                                    ...
                                                    name="email" value="{{ old('email', $konfig->email) }}">
                                            </div>
                                            @error('email')
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="nama_facebook" value="{{ old('nama_facebook', $konfig->nama_facebook) }}">
                                            </div>
                                            @error('nama_facebook')
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="nama_instagram" value="{{ old('nama_instagram', $konfig->nama_instagram) }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="nama_twitter" value="{{ old('nama_twitter', $konfig->nama_twitter) }}">
                                            </div>
                                            @error('nama_twitter')
                                                <div class="invalid-feedback">
